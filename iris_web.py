...
def main():
    #titulo
    st.title('Modelamiento de Iris by EDR')
    #titulo de sidebar
    ...
    option = ['Linea Regression', 'Logistic Regression', 'SVM']
    model = st.sidebar.selectbox('Which model would you like to use?', option)
